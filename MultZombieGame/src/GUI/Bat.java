...
public class Bat extends JFrame {
	...
	public Bat() {
		...
		if(Option3Home.Weapon.equalsIgnoreCase("axe")){
		JLabel lblYouSeeOn = new JLabel("You have chosen the axe. ");
		contentPane.add(lblYouSeeOn, "cell 0 0");
		}
		
		else if(Option3Home.Weapon.equalsIgnoreCase("handgun")){
			JLabel lblYouSeeOn = new JLabel("You have chosen the handgun. ");
			contentPane.add(lblYouSeeOn, "cell 0 0");
			}
		
		else if(Option3Home.Weapon.equalsIgnoreCase("crobar")){
			JLabel lblYouSeeOn = new JLabel("You have chosen the crobar. ");
			contentPane.add(lblYouSeeOn, "cell 0 0");
			}
		
		else{
			JLabel lblYouSeeOn = new JLabel("You have chosen the baseball bat. ");
			contentPane.add(lblYouSeeOn, "cell 0 0");
			}
