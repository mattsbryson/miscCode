...
public class Fight extends JFrame {
	...
	public Fight() {
		...
		JLabel lblYouSeeOn = new JLabel("As you stand on your feet, you look down to see your greatest nightmare realized. ");
		contentPane.add(lblYouSeeOn, "cell 0 0");
		
		JLabel lblYourSisterSarah = new JLabel("You try to kill Randall but he is too fast. Your journey ends here." );			
