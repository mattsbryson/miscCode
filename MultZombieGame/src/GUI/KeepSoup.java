...
public class KeepSoup extends JFrame {
	...
	public KeepSoup() {
		...
		JLabel lblYouSeeOn = new JLabel("You drink the cold soup in private, when you say you’re getting firewood. ");
		contentPane.add(lblYouSeeOn, "cell 0 0");
		
		JLabel lblYourSisterSarah = new JLabel("You are energized and decide to seek food in the surrounding woods." );
					
		contentPane.add(lblYourSisterSarah, "cell 0 1");
		
		JLabel lblNewLabel = new JLabel("Do you FORAGE FOR BERRIES or INVITE BRAD TO HELP YOU HUNT GAME? ");
		...
		JButton btnMachete = new JButton("Hunt");
